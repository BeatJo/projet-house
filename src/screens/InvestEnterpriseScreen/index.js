...
import { fifthSection, firstSection, secondSection, thirdSection } from '../../data/investData';
import '../../styles/Cart.css'

const InvestEnterpriseScreen = () => {
  ...
  return ( 
    <Container header footer>
      ...
      <section class="page-accueil2-part1">
        <div class="stdContainer">
          <div>
            <h1 class="stdGrosTitre leftTitle">Investissez dans <br />les <span class="stdGrosTitre-underlined">TPE &amp; PME françaises</span></h1>
            <h2>Investissez en direct dans des entreprises françaises et dynamisez votre épargne en soutenant l'économie locale.</h2>
            <div>
              <Link class="stdBtn">Définir vos préférences</Link>
              <Link class="stdBtn stdBtn-transparent">Découvrir les opportunités</Link>
            </div>
          </div>
          <p>Équipage du Wine truck des Trois pinardiers, financé sur Tudigo</p>
        </div>
      </section>
      
      <section className="page-accueil2-part4Chiffres">
      <div className="stdContainer">
        <h2 className="stdGrosTitre">Diversifiez votre épargne, <span className="stdGrosTitre-underlined">investissez autrement</span></h2>
        <div className="page-accueil2-part4Chiffres-content">
          {firstSection.map((item, index) => (<div key={index}>
            <div className="page-accueil2-part4Chiffres-content-img"><img style={{width: '60px'}} src={item.icon} alt="Diversifiez votre épargne, investissez autrement" /></div>
            <div style={{color: "#ff4b68", fontSize: 25}}>{item.number}</div>
      ...
      <section className="page-accueil2-part5">
        <div className="stdContainer">
          {secondSection.map((item, index) => (<div style={{flexDirection: item.left ? "row-reverse" : "row"}} key={index}>
            <div>
            ...
            <div className="page-accueil2-part5-bigImage">
              ...
              <div className={item.left ? "page-accueil2-part5-bigImage-chiffre-right" : "page-accueil2-part5-bigImage-chiffre-left"}><img src={item.number} alt="" /></div>
              <div className={item.left ? "page-accueil2-part5-bigImage-texte-right page-accueil2-part5-bigImage-texte" : "page-accueil2-part5-bigImage-texte-left page-accueil2-part5-bigImage-texte"}>
                <div>
...
export default InvestEnterpriseScreen;